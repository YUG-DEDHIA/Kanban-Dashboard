...
function App() {
  ...
  return (
    <div className="App">
      <Header ticketCounts={Object.fromEntries(Object.entries(ticketsByStatus).map(([status, tickets]) => [status, tickets.length]))} liveMode={liveMode} toggleLiveMode={toggleLiveMode} />
